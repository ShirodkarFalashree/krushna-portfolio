      ...
      <div className='w-[1000px]  h-full'>
        <section className="px-8 py-14 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-10 items-center justify-between relative">
          <div className='w-[600px]'>
            <div className="flex items-center mb-4 space-x-2 px-[8px] py-[6px] border border-dotted border-[#EEEEEE] w-fit rounded-4xl">
            ...
            <h1 className="text-4xl md:text-[74px] leading-[81px] text-[#000000] font-bold mb-3">
          ...
          <div className="relative flex flex-col items-end">
            <div className="bg-white rounded-xl shadow-xl p-4 mb-6 w-80 rotate-6">
            ...
            <div className="bg-white rounded-xl shadow-xl p-4 w-80 -rotate-6">
