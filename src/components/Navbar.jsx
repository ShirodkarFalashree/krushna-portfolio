    ...
    <nav className="bg-white sticky top-0 z-50 border-b border-[#eee] h-[75px] flex items-center justify-center">
      <div className="w-full max-w-7xl px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex">
          <a
            href="#contact"
            className="flex items-center bg-black text-white px-5 py-2 rounded-full font-medium hover:bg-gray-900 transition"
          >
            Contact <FaArrowRight className="ml-2 text-sm" />
          </a>
        </div>
